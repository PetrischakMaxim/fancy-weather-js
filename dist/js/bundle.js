...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_getCurrentBackground__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/getCurrentBackground */ \"./src/modules/getCurrentBackground.js\");\n/* harmony import */ var _modules_getCurrentPosition__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/getCurrentPosition */ \"./src/modules/getCurrentPosition.js\");\n/* harmony import */ var _modules_setCurrentBackgroud__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/setCurrentBackgroud */ \"./src/modules/setCurrentBackgroud.js\");\n/* harmony import */ var _modules_showNowDate__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/showNowDate */ \"./src/modules/showNowDate.js\");\n\n\n\n\n\nwindow.onload = function () {\n  Object(_modules_showNowDate__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\n  Object(_modules_getCurrentPosition__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n};\n\nvar pageWrapper = document.querySelector('.page__wrapper');\nvar pageControls = document.querySelectorAll('.form__toggler');\npageControls.forEach(function (control) {\n  control.addEventListener('click', function (evt) {\n    evt.preventDefault();\n    var currentButton = evt.target;\n\n    if (currentButton.dataset.action === 'update-bg') {\n      Object(_modules_getCurrentBackground__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('morning').then(function (data) {\n        return Object(_modules_setCurrentBackgroud__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(pageWrapper, data);\n      });\n    }\n  });\n});\n\n//# sourceURL=webpack:///./src/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return hideLoader; });\nfunction hideLoader() {\n  var delay = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1000;\n  var loader = document.querySelector('.loader-block');\n  setTimeout(function () {\n    loader.classList.add('hidden');\n  }, delay);\n}\n\n//# sourceURL=webpack:///./src/modules/hideLoader.js?");
